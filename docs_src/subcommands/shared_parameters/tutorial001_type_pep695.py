...
type Name = Annotated[str, Argument(help="The name of the user.")]
type Title = Annotated[str, Option(help="The title of the user.")]
...
type Country = Annotated[str, "The name of a country."]
type Countries = Annotated[list[Country], Option("--country", help="List of countries you've visited.")]
